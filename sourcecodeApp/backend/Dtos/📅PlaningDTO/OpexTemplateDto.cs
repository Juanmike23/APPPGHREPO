/*
 * PGH-DOC
 * File: Dtos/📅PlaningDTO/OpexTemplateDto.cs
...
{
    public class OpexTemplateReadDto
    {
    ...
    public class OpexTemplateCreateDto : OpexTemplateReadDto
    {
    }

    public class OpexTableExportRequest : TableQueryRequest
    {
