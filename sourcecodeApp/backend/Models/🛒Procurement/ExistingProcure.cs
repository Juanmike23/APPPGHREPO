/*
 * PGH-DOC
 * File: Models/🛒Procurement/ExistingProcure.cs
...
namespace PGH.Models.Procurement
{
    public class ExistingProcure
    {
        ...
        //public string? SuratPenetapanPemenang { get; set; }
        //public string? SuratPenunjukanPelaksanaanPekerjaan { get; set; }
        //public string? Keterangan { get; set; }
        //public string? StatusatasKontrakKolomD { get; set; }
        //public string? StatusperpanjangandarikolomI { get; set; }
        //public string? DetailinfodarikolomL { get; set; }
        //public string? DetailinfodarikolomM { get; set; }
        public string? ExtraData { get; set; }
        public DateTime? CreatedAt { get; set; }
        public DateTime? UpdatedAt { get; set; }

        // Navigation optional if you want ParentChild links
        public ICollection<ParentChild>? ParentLinks { get; set; }
        public ICollection<ParentChild>? ChildLinks { get; set; }
    }
}
