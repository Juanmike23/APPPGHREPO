/*
 * PGH-DOC
 * File: Models/🛒Procurement/ProcurementItem.cs
...
namespace PGH.Models.Procurement
{
    public class ProcurementItem
    {
        ...
        public string SourceType { get; set; } = "NEW";
        ...
        public ICollection<ProcurementRelation> ParentRelations { get; set; } = new List<ProcurementRelation>();
        public ICollection<ProcurementRelation> ChildRelations { get; set; } = new List<ProcurementRelation>();
        public ICollection<StatusPengadaan> StatusPengadaanRows { get; set; } = new List<StatusPengadaan>();
    }
}
