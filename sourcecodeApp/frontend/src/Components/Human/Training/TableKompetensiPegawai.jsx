/*
 * PGH-DOC
 * File: src/Components/Human/Training/TableKompetensiPegawai.jsx
...
const KOMPETENSI_PEGAWAI_COLUMNS = [
  "NPP",
  "Nama",
  "Department",
  "JudulTraining",
...
const TableKompetensiPegawai = ({
  apiUrl: customApiUrl,
  endpoint = "KompetensiPegawai",
  ...
  return (
    <TableComponent
      ...
      columns={KOMPETENSI_PEGAWAI_COLUMNS}
...
export default TableKompetensiPegawai;
