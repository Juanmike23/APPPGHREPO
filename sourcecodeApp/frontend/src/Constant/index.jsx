...
//chart Audit
export const PieChart = "Status Audit External";
export const PieChart2 = "Source Audit External"; 
export const DonutChart = "Status Audit Internal";
export const RotatingPieChart = "Source Audit Internal";
export const MaterialDesign = "PIC Audit Unit";
export const BasicBarChart = "PIC Audit Unit";
export const ComboChart = "PIC Audit Unit";

// chart Procurement
export const PieChartProcurement = "SKTI";
export const PieChart2Procurement = "APS"; 
export const DonutChartProcurement = "Status Audit Internal";
export const RotatingPieChartProcurement = "Source Audit Internal";
export const MaterialDesignProcurement = "PIC Audit Unit";
export const BasicBarChartProcurement = "PIC Audit Unit";
export const ComboChartProcurement = "Status Pengadaan";
export const BarChartProcurement = "Status Pengadaan";
